...
@Component({
  selector: 'minedu-convocar-plazas-observadas',
  templateUrl: './convocar-plazas-observadas.component.html',
  styleUrls: ['./convocar-plazas-observadas.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations: mineduAnimations,
})
export class ConvocarPlazasObservadasComponent implements OnInit {
      ...
      this.dataService
        ...
        .subscribe((response: any) => {
          ...
          if ((response || []).length === 0) {
            this.dataService
              .Message()
              .msgWarning('"NO SE ENCONTRÓ INFORMACIÓN DE LAS PLAZAS OBSERVADAS PARA LOS CRITERIOS DE BÚSQUEDA."', () => { });
          }
        });
    }
  }
