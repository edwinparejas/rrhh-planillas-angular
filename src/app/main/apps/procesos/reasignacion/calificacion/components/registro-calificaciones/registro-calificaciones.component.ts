...
export class RegistroCalificacionesComponent implements OnInit {
  ...
  configurarDatoInicial = () => {
    if (this.data.idOperacion === TipoOperacionEnum.Registrar) {
        this.dialogTitle = 'Registrar calificaciones';
    } else if (this.data.idOperacion === TipoOperacionEnum.Modificar) {
        this.dialogTitle = 'Editar calificaciones';
        this.GetCalificacionesResultados();
    }else if (this.data.idOperacion === TipoOperacionEnum.Ver) {
  ...
  private GetCalificacionesResultados = () => {
     const { idEtapaProceso, idCalificacionDetalle } = this.data;
     const data = {
  ...
  */
  ...
  handleRegistrar = () => {
    ...
    let mensajeAnotaciones = '';
          ...
          if((!cumpleRequisitosGenerales && !cumpleVerificarImpedimentos) && (anotacionesEvaluacionExpediente == null || anotacionesEvaluacionExpediente == "")){
