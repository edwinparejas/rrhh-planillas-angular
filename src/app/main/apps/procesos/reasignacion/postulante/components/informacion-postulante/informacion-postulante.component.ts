...
import { CapacitacionModel, DocumentoSustentoModel, ExperienciaLaboralCalc, ExperienciaLaboralModel, FormacionAcademicaModel, PostulacionModel, ServidorPublicoModel } from '../../../models/reasignacion.model';
