...
@Component({
  selector: 'minedu-buscar-servidor-publico',
  templateUrl: './buscar-servidor-publico.component.html',
  styleUrls: ['./buscar-servidor-publico.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations: mineduAnimations,
})
export class BuscarServidorPublicoComponent implements OnInit, AfterViewInit {
  form: FormGroup;
  ...
  constructor(
    public matDialogRef: MatDialogRef<BuscarServidorPublicoComponent>,
      ...
      .subscribe((response) => {
        if (response) {
         const data = response.map((x) => ({
            ...x,
            idCatalogoItem: x.codigo,
            descripcionCatalogoItem: `${x.descripcion}`,
            id: x.id
          }));
