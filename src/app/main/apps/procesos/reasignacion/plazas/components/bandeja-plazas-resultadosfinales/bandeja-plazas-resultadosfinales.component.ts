...
export class BandejaPlazasResultadosfinalesComponent implements OnInit {
    ...
    handleExportarPlazasResultadoFinal = () => {
        ...
        this.dataService
            .Reasignaciones()
            .exportarPlazaReasignacionResultadoFinal(this.request)
            .pipe(
...
export class ResultadosFinalesDataSource extends DataSource<any> {
    ...
    load(data: any, pageIndex, pageSize, selectedTabIndex: number): void {
        this.dataService.Reasignaciones()
            .getGridPlazaReasignacionResultadoFinal(data, pageIndex, pageSize)
            .pipe(
                catchError(() => of(null)),
                finalize(() => {
