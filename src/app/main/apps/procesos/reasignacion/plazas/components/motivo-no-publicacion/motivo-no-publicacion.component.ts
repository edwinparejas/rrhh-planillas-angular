...
@Component({
  selector: 'minedu-motivo-no-publicacion',
  templateUrl: './motivo-no-publicacion.component.html',
  styleUrls: ['./motivo-no-publicacion.component.scss']
})
export class MotivoNoPublicacionComponent implements OnInit {
    form: FormGroup;
    comboLists = {
        listTiposSustento: [],
    ...
    constructor(
        public matDialogRef: MatDialogRef<MotivoNoPublicacionComponent>,
    ...
    handleInfo = (row: any, i) => {
        ...
        this.dialogRef = this.materialDialog.open(MotivoNoPublicacionComponent, {
