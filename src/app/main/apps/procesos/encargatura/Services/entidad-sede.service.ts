...
import { PassportTipoSede, TablaRolPassport } from '../_utils/constants';
...
export class EntidadSedeService {
    ...
    proccessInit() {
        ...
        if(this.passportRolSelected.CODIGO_TIPO_SEDE==PassportTipoSede.MINEDU){
            entidadSede.codigoSede='000000';
        }
