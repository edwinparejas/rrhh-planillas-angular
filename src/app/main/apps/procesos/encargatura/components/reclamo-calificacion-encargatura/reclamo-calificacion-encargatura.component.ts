...
@Component({
    selector: 'minedu-reclamo-calificacion-encargatura',
    templateUrl: './reclamo-calificacion-encargatura.component.html',
    styleUrls: ['./reclamo-calificacion-encargatura.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: mineduAnimations
})
export class ReclamoCalificacionEncargaturaComponent implements OnInit {
    idCalificacion: number;
    calificacion: any;
    
    constructor(
        public dialogRef: MatDialogRef<ReclamoCalificacionEncargaturaComponent>,
