...
import { BuscarCentroTrabajoComponent } from '../../../../../asistencia/control-consolidado/buscar-centro-trabajo/buscar-centro-trabajo.component';
import { BusquedaPlazaComponent } from '../../../../rotacion/components/busqueda-plaza/busqueda-plaza.component';
...
@Component({
  selector: 'minedu-adjudicar-plaza-eval',
  templateUrl: './adjudicar-plaza-eval.component.html',
  styleUrls: ['./adjudicar-plaza-eval.component.scss'],
  animations: mineduAnimations,
  encapsulation: ViewEncapsulation.None,
})
export class AdjudicarPlazaEvalComponent implements OnInit {
    ...
    handleBuscar = () => {
        ...
        .subscribe((d: any) => {
            console.log("datos de busqueda plazas: ",d);
            if ((d || []).length === 0 && !this.firstTime) {
                ...
                this.dataService.Contrataciones().putAdjudicarPlazaPUN(this.requestAdjudicar).pipe(
                    ...
                    .subscribe((response: any) => {
                        if (response > -1) {
                            ...
                            this.router.navigate(["./../../../"], { relativeTo: this.route }); // RETORNAR
                        } else {
                            let r = response[0];
