...
@Component({
  selector: 'minedu-modal-no-adjudicar-eval',
  templateUrl: './modal-no-adjudicar-eval.component.html',
  styleUrls: ['./modal-no-adjudicar-eval.component.scss'],
  animations: mineduAnimations,
  encapsulation: ViewEncapsulation.None,
})
export class ModalNoAdjudicarEvalComponent implements OnInit {
    ...
    constructor(
        public matDialogRef: MatDialogRef<ModalNoAdjudicarEvalComponent>,
