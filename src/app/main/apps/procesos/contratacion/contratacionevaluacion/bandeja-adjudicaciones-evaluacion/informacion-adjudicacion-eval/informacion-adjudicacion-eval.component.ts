...
@Component({
  selector: 'minedu-informacion-adjudicacion-eval',
  templateUrl: './informacion-adjudicacion-eval.component.html',
  styleUrls: ['./informacion-adjudicacion-eval.component.scss'],
  animations: mineduAnimations,
  encapsulation: ViewEncapsulation.None,
})
export class InformacionAdjudicacionEvalComponent implements OnInit {
