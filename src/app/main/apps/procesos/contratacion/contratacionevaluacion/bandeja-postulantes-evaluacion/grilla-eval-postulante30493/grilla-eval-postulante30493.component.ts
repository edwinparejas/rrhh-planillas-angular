...
import { EstadoPostulacionEnum, MensajesSolicitud } from '../../../_utils/constants';
...
@Component({
  selector: 'minedu-grilla-eval-postulante30493',
  templateUrl: './grilla-eval-postulante30493.component.html',
  styleUrls: ['./grilla-eval-postulante30493.component.scss'],
    animations: mineduAnimations,
    encapsulation: ViewEncapsulation.None,
})
export class GrillaEvalPostulante30493Component implements OnInit {
    dialogRef: any;
  ...
  ngOnInit(): void {
    ...
    informacionPostulanteView = (dataPostulante:any) => {
		...
		data: {
		    icon: "save",
		    title: "Editar datos de postulante",
		    idEtapaProceso: this.idEtapaProceso,
		    dataForm: dataPostulante,
		    soloLectura:true
		}
	    });
	    this.dialogRef
