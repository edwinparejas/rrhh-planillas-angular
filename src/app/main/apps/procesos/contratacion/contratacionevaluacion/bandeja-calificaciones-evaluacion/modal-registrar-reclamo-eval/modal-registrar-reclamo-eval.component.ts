...
@Component({
  selector: 'minedu-modal-registrar-reclamo-eval',
  templateUrl: './modal-registrar-reclamo-eval.component.html',
  styleUrls: ['./modal-registrar-reclamo-eval.component.scss']
})
export class ModalRegistrarReclamoEvalComponent implements OnInit {
    ...
    constructor(
        public matDialogRef: MatDialogRef<ModalRegistrarReclamoEvalComponent>,
