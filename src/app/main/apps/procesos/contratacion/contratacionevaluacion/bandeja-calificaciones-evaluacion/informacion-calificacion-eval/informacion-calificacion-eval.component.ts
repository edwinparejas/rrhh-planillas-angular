...
@Component({
  selector: 'minedu-informacion-calificacion-eval',
  templateUrl: './informacion-calificacion-eval.component.html',
  styleUrls: ['./informacion-calificacion-eval.component.scss'],
  animations: mineduAnimations,
    encapsulation: ViewEncapsulation.None,
})
export class InformacionCalificacionEvalComponent implements OnInit {
