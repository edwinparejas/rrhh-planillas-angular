...
export class FormacionAcademicaComponent implements OnInit {
    ...
    loadNivelEducativa = () => {
        this.dataService.Contrataciones().getAllComboNivelEducativa().pipe(
            catchError(() => of([])),
            finalize(() => { })
    ...
    loadAreaCurricular = () => {
        this.dataService.Contrataciones().getComboAreacurricular().pipe(
            catchError(() => of([])),
            finalize(() => { })
        ).subscribe((response: any) => {
            if (response && response.result) {
    ...
    loadGradoEstudio = () => {
        this.dataService.Contrataciones().getComboGradoEstudio().pipe(
            catchError(() => of([])),
            finalize(() => { })
        ).subscribe((response: any) => {
            if (response && response.result) {
    ...
    loadCentroEstudio = () => {
        this.dataService.Contrataciones().getComboCentroEstudio().pipe(
            catchError(() => of([])),
            finalize(() => { })
        ).subscribe((response: any) => {
            if (response && response.result) {
    ...
    loadEstudioCompleto = () => {
        this.dataService.Contrataciones().getComboEstudioCompleto().pipe(
            catchError(() => of([])),
            finalize(() => { })
        ).subscribe((response: any) => {
            if (response && response.result) {
