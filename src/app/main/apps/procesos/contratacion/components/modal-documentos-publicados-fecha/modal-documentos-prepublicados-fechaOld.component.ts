...
@Component({
    ...
    templateUrl: "./modal-documentos-prepublicados-fechaOld.component.html",
    styleUrls: ["./modal-documentos-prepublicados-fechaOld.component.scss"],
    animations: mineduAnimations,
    encapsulation: ViewEncapsulation.None,
})
export class ModalDocumentosPrepublicadosFechaOldComponent implements OnInit {
    ...
    constructor(
        public matDialogRef: MatDialogRef<ModalDocumentosPrepublicadosFechaOldComponent>,
    ...
    handleVerPlazasPdf(row:any, becario: boolean) {
        if (!becario){
	    if(this.idRegimenLaboral == RegimenLaboralEnum.LEY_30493)
	    {
		this.dialogRef = this.materialDialog.open(ModalDocumentosPublicadosPrepublicacionComponent, {
			...
			nombreDocumento: 'Plazas_Contratación_Auxiliares',
			esbecario:becario,
