...
@Component({
    selector: "minedu-busqueda-plaza-postulante",
    templateUrl: "./busqueda-plaza-postulante.component.html",
    styleUrls: ["./busqueda-plaza-postulante.component.scss"],
    encapsulation: ViewEncapsulation.None,
    animations: mineduAnimations,
})
export class BusquedaPlazaPostulanteComponent
...
export class PlazaDataSource extends DataSource<any> {
    ...
    load(data: any, pageIndex, pageSize): void {
        ...
        //} else {
            ...
            this.dataService
                .Contrataciones()
                .buscarPlazasPostulantePaginado(data, pageIndex, pageSize)
                .pipe(
                    catchError(() => of([])),
                    finalize(() => {
                        this._loadingChange.next(false);
