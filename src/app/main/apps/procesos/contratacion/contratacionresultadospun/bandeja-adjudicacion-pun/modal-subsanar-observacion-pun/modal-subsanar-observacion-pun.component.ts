...
@Component({
    selector: 'minedu-modal-subsanar-observacion-pun',
    templateUrl: './modal-subsanar-observacion-pun.component.html',
    styleUrls: ['./modal-subsanar-observacion-pun.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: mineduAnimations,
})
export class ModalSubsanarObservacionPUNComponent implements OnInit {
    ...
    constructor(
        public matDialogRef: MatDialogRef<ModalSubsanarObservacionPUNComponent>,
	...
	this.modoEditar = this.data.editar;
