...
@Component({
    selector: 'minedu-modal-observar-postulacion-pun',
    templateUrl: './modal-observar-postulacion-pun.component.html',
    styleUrls: ['./modal-observar-postulacion-pun.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: mineduAnimations,
})
export class ModalObservarPostulacionPUNComponent implements OnInit {
    ...
    constructor(
        public matDialogRef: MatDialogRef<ModalObservarPostulacionPUNComponent>,
