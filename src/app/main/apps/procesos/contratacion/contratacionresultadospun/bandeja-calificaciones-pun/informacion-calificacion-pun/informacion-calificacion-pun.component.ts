...
@Component({
    selector: 'minedu-informacion-calificacion-pun',
    templateUrl: './informacion-calificacion-pun.component.html',
    styleUrls: ['./informacion-calificacion-pun.component.scss'],
    animations: mineduAnimations,
    encapsulation: ViewEncapsulation.None,
})
export class InformacionCalificacionPUNComponent implements OnInit {
    ...
    obtenerInformación = () => {
        ...
        .subscribe((response: any) => {
            if (response) {
                this.info = response;
                console.log("Respuesta Calificacion PUN:", response);
                ...
                console.log("Rubro cabecera PUN: ", this.rubroCab);
                this.info.rubro.forEach((r, i) => {
                    ...
                    console.log("Datasource sin load", this.dtSource);
                    this.dtSource[i].load(d);
                    console.log("Datasource con load", this.dtSource);
...
export class EvaluacionDataSource extends DataSource<any> {
    ...
    load(data: any): void {
        ...
        if (data.idCalificacion === null) {
            ...
            .subscribe((d: any) => {
                console.log("Calificacion Rubro Detalle k;",d);
