...
export enum DescripcionMaestroProcesoEnum {
    ...
    PRE_PUBLICACION_DE_PLAZAS_AUXILIARES = 26,
    CONTRATACION_DOCENTE_AUXILIARES = 6,
}
...
export interface IActualizarPlazaPublicacionSituacionValidacionViewModel {
    ...
    usuarioModificacion: string;
    codigoCentroTrabajoMaestro:string;
    isSeleccionadoTodosPrepublicadas:boolean;
}
...
// 30493 - permisos
export class plazaBotonesGrillaActivos_30493{
    btnMigrarPlazasDesiertas : boolean = false;
    btnIncorporarPlazas : boolean= false;;
    btnPlazasConvocar : boolean= false;;
    btnPlazasObservados : boolean= false;;
