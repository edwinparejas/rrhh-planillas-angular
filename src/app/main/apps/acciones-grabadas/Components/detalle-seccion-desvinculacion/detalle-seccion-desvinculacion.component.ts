...
@Component({
    selector: 'minedu-detalle-seccion-desvinculacion',
    templateUrl: './detalle-seccion-desvinculacion.component.html',
    styleUrls: ['./detalle-seccion-desvinculacion.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: mineduAnimations
})
export class DetalleSeccionDesvinculacionComponent implements OnInit {
