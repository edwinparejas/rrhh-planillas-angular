...
@Component({
    selector: 'minedu-detalle-seccion-comite',
    templateUrl: './detalle-seccion-comite.component.html',
    styleUrls: ['./detalle-seccion-comite.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: mineduAnimations
})
export class DetalleSeccionComiteComponent implements OnInit {
    ...
    ngOnInit(): void {    
        ...
        this.detalleVistaProyecto.forEach(async (detalle) => {        
            ...
            splitg.forEach(async (split) => {
                ...
                let bold=(cantidad==3||cantidad==1||split==":"?1:0);
