...
import { ResultadoOperacionEnum, TipoDocumentoIdentidadEnum } from "../../_utils/constants";
...
@Component({
  selector: "minedu-proyresolucion-buscador-servidor-publico",
...
export class BuscadorServidorPublicoComponent  implements OnInit , AfterViewInit {
    ...
    loadTipoDocumentoIdentidad = () => {
        this.dataService.ProyectosResolucion().getComboTipodocumento().pipe(
            catchError(() => of([])),
            finalize(() => { })
...
export class ServidorPublicoDataSource extends DataSource<any>{
    ...
    load(data: any, pageIndex, pageSize): void {
        ...
        this.dataService.ProyectosResolucion().getListaServidorPublico(data, pageIndex, pageSize).pipe(catchError((error) => {
