...
export  const MESSAGE_LICENCIAS = {
    ...
    RESULT_NULL_EXPORTAR: '"NO SE ENCONTRÓ INFORMACIÓN PARA PARA EXPORTAR"',
    RESULT_NULL_BUSQUEDA: '"NO SE ENCONTRÓ INFORMACIÓN PARA LOS CRITERIOS DE BÚSQUEDA INGRESADO"',
    RESULT_NULL_SERVIDOR_PUBLICO: '"SERVIDOR PÚBLICO NO SE ENCUENTRA REGISTRADO"',
    INVALID_SERVIDOR_PUBLICO: '"DEBE SELECCIONAR UN SERVIDOR PÚBLICO"',
    INVALID_SERVIDOR_PUBLICO_CESADO: '"SERVIDOR PÚBLICO SE ENCUENTRA CESADO, NO SE PUEDE REGISTRAR LICENCIA"',
