...
import { InstanciaModel } from "../../../models/vinculacion.model";

@Component({
    selector: "minedu-modal-monitor-vinculacion",
    templateUrl: "./modal-monitor-vinculacion.component.html",
    styleUrls: ["./modal-monitor-vinculacion.component.scss"],
    encapsulation: ViewEncapsulation.None,
    animations: mineduAnimations,
})
export class ModalMonitorVinculacionComponent implements OnInit {
    form: FormGroup;
    @ViewChild("tree") tree;
    treeData: any[] = [];
    ...
    constructor(
        public matDialogRef: MatDialogRef<ModalMonitorVinculacionComponent>,
    ...
    instanciaSelected(node: ItemFlatNode) {
        ...
        this.dataService.AccionesVinculacion().setInstanciaSelected(intancia);
