...
@Component({
  selector: 'minedu-anular-beneficio',
  templateUrl: './anular-beneficio.component.html',
  styleUrls: ['./anular-beneficio.component.scss'],
  encapsulation: ViewEncapsulation.None,
    animations: mineduAnimations
})
export class AnularBeneficioComponent implements OnInit {
...
getValueOrNullFromCero(value){
  ...
  handleCancelar =()=>{
    ...
    handleEliminar=()=>{
        // var data = {
        //     Id : parseInt(this.idDetalleGestionBeneficio,10)
        // }
        let queryParam = new HttpParams();
        queryParam = queryParam.set('id', this.idDetalleGestionBeneficio);
        this.dataService.Message().msgConfirm(MensajesSolicitud.M05, () => {
            this.dataService
            .Beneficios()
            .deleteDetalleBeneficio(queryParam)
