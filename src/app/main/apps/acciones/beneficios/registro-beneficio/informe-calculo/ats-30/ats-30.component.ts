...
@Component({
  selector: 'minedu-ats-30',
  templateUrl: './ats-30.component.html',
  styleUrls: ['./ats-30.component.scss'],
  encapsulation: ViewEncapsulation.None,
    animations: mineduAnimations
})
export class Ats30Component implements OnInit {
    ...
    * Métodos Integración Back*/
    ...
    guardar(){
        ...
        this.dataService.Message().msgConfirm('¿ESTÁ SEGURO QUE DESEA GUARDAR LA INFORMACIÓN?', () => {
            ...
            this.dataService.Beneficios().guardarBeneficioATS30(generarFormDataUtil(this.form.value)).pipe(
