...
import { BonificacionFamiliarDataSource } from './DataSource/BonificacionFamiliarDataSource';

@Component({
  selector: 'minedu-bonificacion-familiar',
  templateUrl: './bonificacion-familiar.component.html',
  styleUrls: ['./bonificacion-familiar.component.scss'],
  encapsulation: ViewEncapsulation.None,
    animations: mineduAnimations
})
export class BonificacionFamiliarComponent implements OnInit,AfterContentInit { 

    @Input() form:FormGroup;
    disabled:boolean = true;
    dialogRef: any;
    isMobile = false;
    dataSource: BonificacionFamiliarDataSource | null;
  ...
  buildGrid() {
    ...
    this.dataSource = new BonificacionFamiliarDataSource(this.dataService, this.paginator);
...
/**
 ...
 guardar(){
    ...
    this.dataService.Message().msgConfirm('¿ESTÁ SEGURO QUE DESEA GUARDAR LA INFORMACIÓN?', () => {
        ...
        //this.dataService.Spinner().show("sp6");
        this.dataService.Beneficios().guardarBeneficioBonificacionFamiliar(generarFormDataUtil(this.form.value)).pipe(
