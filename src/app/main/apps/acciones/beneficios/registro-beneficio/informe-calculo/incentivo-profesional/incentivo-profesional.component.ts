...
@Component({
  selector: 'minedu-incentivo-profesional',
  templateUrl: './incentivo-profesional.component.html',
  styleUrls: ['./incentivo-profesional.component.scss'],
  encapsulation: ViewEncapsulation.None,
    animations: mineduAnimations
})
export class IncentivoProfesionalComponent implements OnInit {
    ...
    * Métodos Integración Back*/
     ...
     guardar(){
        ...
        this.dataService.Message().msgConfirm('¿ESTÁ SEGURO QUE DESEA GUARDAR LA INFORMACIÓN?', () => {
            ...
            this.dataService.Beneficios().guardarBeneficioIncentivoProfesional(generarFormDataUtil(this.form.value)).pipe(
