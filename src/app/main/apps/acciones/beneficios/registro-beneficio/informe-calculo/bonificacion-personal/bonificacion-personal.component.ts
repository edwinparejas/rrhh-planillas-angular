...
@Component({
  selector: 'minedu-bonificacion-personal',
  templateUrl: './bonificacion-personal.component.html',
  styleUrls: ['./bonificacion-personal.component.scss'],
  encapsulation: ViewEncapsulation.None,
    animations: mineduAnimations
})
export class BonificacionPersonalComponent implements OnInit {
    ...
    * Métodos Integración Back*/
     ...
     guardar(){
        ...
        this.dataService.Message().msgConfirm('¿ESTÁ SEGURO QUE DESEA GUARDAR LA INFORMACIÓN?', () => {
            ...
            this.dataService.Beneficios().guardarBeneficioBonificacionPersonal(generarFormDataUtil(this.form.value)).pipe(
