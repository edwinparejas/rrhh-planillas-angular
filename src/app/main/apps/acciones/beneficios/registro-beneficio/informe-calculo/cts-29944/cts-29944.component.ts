...
@Component({
  selector: 'minedu-cts-29944',
  templateUrl: './cts-29944.component.html',
  styleUrls: ['./cts-29944.component.scss'],
  encapsulation: ViewEncapsulation.None,
    animations: mineduAnimations
})
export class cts29944Component implements OnInit {
    ...
    validarGuardar(){
     ...
     guardar(){
        ...
        this.dataService.Message().msgConfirm('¿ESTÁ SEGURO QUE DESEA GUARDAR LA INFORMACIÓN?', () => {
            ...
            this.dataService.Beneficios().guardarBeneficioCTS29944(generarFormDataUtil(this.form.value)).pipe(
