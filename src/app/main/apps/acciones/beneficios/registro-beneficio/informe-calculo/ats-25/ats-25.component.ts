...
@Component({
  selector: 'minedu-ats-25',
  templateUrl: './ats-25.component.html',
  styleUrls: ['./ats-25.component.scss'],
  encapsulation: ViewEncapsulation.None,
    animations: mineduAnimations
})
export class Ats25Component implements OnInit {
    ...
    * Métodos Integración Back*/
     ...
     guardar(){
        ...
        this.dataService.Message().msgConfirm('¿ESTÁ SEGURO QUE DESEA GUARDAR LA INFORMACIÓN?', () => {
            ...
            this.dataService.Beneficios().guardarBeneficioATS25(generarFormDataUtil(this.form.value)).pipe(
