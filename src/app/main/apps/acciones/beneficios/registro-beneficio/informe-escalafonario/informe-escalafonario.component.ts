...
@Component({
  selector: 'minedu-informe-escalafonario',
  templateUrl: './informe-escalafonario.component.html',
  styleUrls: ['./informe-escalafonario.component.scss'],
  encapsulation: ViewEncapsulation.None,
    animations: mineduAnimations
})
export class InformeEscalafonarioComponent implements OnInit {
