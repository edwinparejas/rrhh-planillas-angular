...
@Component({
  selector: 'minedu-editar-premio-anual',
  templateUrl: './editar-premio-anual.component.html',
  styleUrls: ['./editar-premio-anual.component.scss'],
  encapsulation: ViewEncapsulation.None,
    animations: mineduAnimations
})
export class EditarPremioAnualComponent implements OnInit {
    ...
    * Métodos Integración Back*/
     guardar(){
        ...
        this.dataService.Message().msgConfirm('¿ESTÁ SEGURO QUE DESEA GUARDAR LA INFORMACIÓN?', () => {
            ...
            this.dataService.Beneficios().guardarEditarBeneficioPremioAnual(this.getData()).pipe(
    ...
    * Métodos Util */
    ...
    onKeyPressImporteBeneficio(e: any): boolean {
      ...
      getData() {
        ...
        idDetalleGestionBeneficio: dataForm.idDetalleGestionBeneficio,
        //Acción Personal
