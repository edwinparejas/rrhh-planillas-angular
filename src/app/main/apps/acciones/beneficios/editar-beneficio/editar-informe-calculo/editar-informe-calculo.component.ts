...
@Component({
  selector: 'minedu-editar-informe-calculo',
  templateUrl: './editar-informe-calculo.component.html',
  styleUrls: ['./editar-informe-calculo.component.scss'],
  encapsulation: ViewEncapsulation.None,
    animations: mineduAnimations
})
export class EditarInformeCalculoComponent implements OnInit {
