...
import { NivelInstanciaCodigoEnum, TablaUsuarioRolEnum, TipoCentroTrabajoCodigoEnum } from "../../types/Enums";
...
export class BuscarCentroTrabajoComponent
    ...
    async datosSede() {
        ...
        var response = await this.dataService.AccionesPlazaEspejo()
            ...
            .subscribe((response) => {
                if (response) {
                    ...
                    if (
                        ...
                        TablaUsuarioRolEnum.EspecialistaAIRHSP
                    ) {
...
export class CentroTrabajoDataSource extends DataSource<any> {
    ...
    load(data: any, paginaActual, tamanioPagina) {
        this._loadingChange.next(true);

        this.dataService
            .AccionesPlazaEspejo()
            .getCentroTrabajoPaginado({ ...data, paginaActual, tamanioPagina })
            .pipe(
                catchError((e) => of(e)),
                finalize(() => {
                    this._loadingChange.next(false);
