...
@Component({
    selector: 'minedu-datos-vacaciones-info',
    templateUrl: './datos-vacaciones-info.component.html',
    styleUrls: ['./datos-vacaciones-info.component.scss']
})
export class DatosVacacionesInfoComponent implements OnInit, OnDestroy {
    @Input('vacaciones')
    vacaciones: any;
    ...
    private async cargarAccionPersonal() {
        ...
        let idTipoCargo = this.vacaciones?.idTipoCargo ?? this.actividadResolucion?.idTipoCargoNuevo;
        let idCargo = this.vacaciones?.idCargo ?? this.actividadResolucion?.idCargoNuevo;
        let idJornadaLaboral = this.vacaciones?.idJornadaLaboral ?? this.actividadResolucion?.idJornadaNuevo;
