...
@Component({
    selector: 'minedu-vacaciones-popup',
    templateUrl: './vacaciones-popup.component.html',
    styleUrls: ['./vacaciones-popup.component.scss']
})
export class VacacionesPopupComponent implements OnInit {
    ...
    constructor(public matDialogRef: MatDialogRef<VacacionesPopupComponent>,
    ...
    ngOnInit(): void {
        ...
        this.vacaciones = this.data?.datoRegistro ?? null;
