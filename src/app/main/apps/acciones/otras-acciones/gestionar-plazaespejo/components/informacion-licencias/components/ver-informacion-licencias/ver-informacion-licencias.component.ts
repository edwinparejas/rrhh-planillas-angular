...
@Component({
    selector: 'minedu-ver-informacion-licencias',
    templateUrl: './ver-informacion-licencias.component.html',
    styleUrls: ['./ver-informacion-licencias.component.scss']
})
export class VerInformacionLicenciasComponent implements OnInit, OnDestroy {
