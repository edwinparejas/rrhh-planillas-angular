...
@Component({
    selector: 'minedu-sanciones-popup',
    templateUrl: './sanciones-popup.component.html',
    styleUrls: ['./sanciones-popup.component.scss']

})
export class SancionesPopupComponent implements OnInit {
    ...
    constructor(public matDialogRef: MatDialogRef<SancionesPopupComponent>,
    ...
    ngOnInit(): void {
        ...
        this.sancion = this.data?.datoRegistro ?? null;
