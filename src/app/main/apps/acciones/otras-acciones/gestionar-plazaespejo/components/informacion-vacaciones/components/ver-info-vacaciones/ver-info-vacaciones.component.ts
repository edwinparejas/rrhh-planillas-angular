...
@Component({
    selector: 'minedu-ver-info-vacaciones',
    templateUrl: './ver-info-vacaciones.component.html',
    styleUrls: ['./ver-info-vacaciones.component.scss']
    
})
export class VerInfoVacacionesComponent implements OnInit, OnDestroy {
