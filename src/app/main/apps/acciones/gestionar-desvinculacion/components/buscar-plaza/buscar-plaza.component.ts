...
import { TipoFormatoPlazaEnum, criterioBusqueda } from '../../models/desvinculacion.model';
...
if(this.idRegimenLaboral)this.setUpIdRegimenLaboral();
  ...
  loadRegimenLaboral = () => { 
      ...
      this.dataService.AccionesDesvinculacion().getComboRegimenLaboral(data).subscribe(
        (response) => {
