...
export class ReasignacionesRestangularService {
    ...
    constructor(
        ...
        this.baseUrl = basePath.reasignacionesApi;
    }
    ...
    clone(): ReasignacionesRestangularService {
        return new ReasignacionesRestangularService(this._http, this.router, {
            reasignacionesApi: this.baseUrl,
