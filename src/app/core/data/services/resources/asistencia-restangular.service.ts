...
export class AsistenciaRestangularService {
    ...
    constructor(
        ...
        this.baseUrl = basePath.asistenciaApi;
    }
    ...
    post(obj?: any, queryParams?: HttpParams): Observable<Response> {
        return this._http
            .post(this.baseUrl, obj, { params: queryParams })
            .pipe(
                catchError(this.handleError),
                map((response) => {
                    return response as any;
    ...
    clone(): AsistenciaRestangularService {
        return new AsistenciaRestangularService(this._http, this.router, {
            asistenciaApi: this.baseUrl,
