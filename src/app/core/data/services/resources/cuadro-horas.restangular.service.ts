...
export class CuadroHorasRestangularService {
    ...
    constructor(
        ...
        this.baseUrl = basePath.cuadroHorasApi;
    }
    ...
    one(path: string, id: string): CuadroHorasRestangularService {
        const restangular = this.clone();
        restangular.baseUrl += (path ? '/' + path : '') + '/' + id;
        return restangular;
    }

    all(path: string): CuadroHorasRestangularService {
        const restangular = this.clone();
    ...
    clone(): CuadroHorasRestangularService {
        return new CuadroHorasRestangularService(this._http, this.router, {
              cuadroHorasApi: this.baseUrl,
