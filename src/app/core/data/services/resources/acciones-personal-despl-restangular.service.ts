...
export class AccionesPersonalDesplRestangularService {
    ...
    constructor(
        ...
        this.baseUrl = basePath.accionesDesplazamientoApi;
    }
    ...
    one(path: string, id: string): AccionesPersonalDesplRestangularService {
        const restangular = this.clone();
        restangular.baseUrl += (path ? "/" + path : "") + "/" + id;
        return restangular;
    }

    all(path: string): AccionesPersonalDesplRestangularService {
        const restangular = this.clone();
    ...
    clone(): AccionesPersonalDesplRestangularService {
        return new AccionesPersonalDesplRestangularService(this._http, this.router, { accionesDesplazamientoApi: this.baseUrl } as RestangularBasePath);
    }
