...
export class SancionesRestangularService {
    ...
    constructor(
        ...
        this.baseUrl = basePath.sancionesApi;
    }
    ...
    one(path: string, id: string): SancionesRestangularService {
        const restangular = this.clone();
        restangular.baseUrl += (path ? '/' + path : '') + '/' + id;
        return restangular;
    }

    all(path: string): SancionesRestangularService {
        const restangular = this.clone();
    ...
    clone(): SancionesRestangularService {
        return new SancionesRestangularService(this._http, this.router, {
            sancionesApi: this.baseUrl,
