...
export class AccionesPlazaEspejoRestangularService {
    ...
    one(path: string, id: string): AccionesPlazaEspejoRestangularService {
        const restangular = this.clone();
        restangular.baseUrl += (path ? "/" + path : "") + "/" + id;
        return restangular;
    }

    all(path: string): AccionesPlazaEspejoRestangularService {
        const restangular = this.clone();
    ...
    clone(): AccionesPlazaEspejoRestangularService {
        return new AccionesPlazaEspejoRestangularService(this._http, this.router, {
