...
export class AscensoRestangularService {
    ...
    constructor(
        ...
        this.baseUrl = basePath.ascensoApi;
    }
    ...
    one(path: string, id: string): AscensoRestangularService {
        const restangular = this.clone();
        restangular.baseUrl += (path ? '/' + path : '') + '/' + id;
        return restangular;
    }

    all(path: string): AscensoRestangularService {
        const restangular = this.clone();
    ...
    clone(): AscensoRestangularService {
        return new AscensoRestangularService(this._http, this.router, {
            ascensoApi: this.baseUrl,
