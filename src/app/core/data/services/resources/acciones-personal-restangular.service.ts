...
export class AccionesPersonalRestangularService {
    ...
    constructor(
        ...
        this.baseUrl = basePath.accionesApi;
    }
    ...
    one(path: string, id: string): AccionesPersonalRestangularService {
        const restangular = this.clone();
        restangular.baseUrl += (path ? "/" + path : "") + "/" + id;
        return restangular;
    }

    all(path: string): AccionesPersonalRestangularService {
        const restangular = this.clone();
    ...
    clone(): AccionesPersonalRestangularService {
        return new AccionesPersonalRestangularService(this._http, this.router, { accionesApi: this.baseUrl } as RestangularBasePath);
    }
