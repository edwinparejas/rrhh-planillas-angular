...
export class RotacionRestangularService {
    ...
    constructor(
        ...
        this.baseUrl = this.basePath.rotacionApi;
    }
    ...
    clone(): RotacionRestangularService {
        return new RotacionRestangularService(this._http, this.router, {
            rotacionApi: this.baseUrl,
