...
export class ContratacionesRestangularService {
    ...
    constructor(
        ...
        this.baseUrl = basePath.contratacionesApi;
    }
    ...
    one(path: string, id: string): ContratacionesRestangularService {
        const restangular = this.clone();
        restangular.baseUrl += (path ? "/" + path : "") + "/" + id;
        return restangular;
    }

    all(path: string): ContratacionesRestangularService {
        const restangular = this.clone();
    ...
    clone(): ContratacionesRestangularService {
        return new ContratacionesRestangularService(this._http, this.router, {
            contratacionesApi: this.baseUrl,
