...
export class OtrasFuncionalidadesRestangularService {
    ...
    one(path: string, id: string): OtrasFuncionalidadesRestangularService {
        const restangular = this.clone();
        restangular.baseUrl += (path ? "/" + path : "") + "/" + id;
        return restangular;
    }

    all(path: string): OtrasFuncionalidadesRestangularService {
        const restangular = this.clone();
    ...
    clone(): OtrasFuncionalidadesRestangularService {
        return new OtrasFuncionalidadesRestangularService(this._http, this.router, {
