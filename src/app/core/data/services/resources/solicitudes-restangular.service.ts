...
export class SolicitudesRestangularService {
    ...
    constructor(
        ...
        this.baseUrl = basePath.solicitudesApi;
    }
    ...
    one(path: string, id: string): SolicitudesRestangularService {
        const restangular = this.clone();
        restangular.baseUrl += (path ? "/" + path : "") + "/" + id;
        return restangular;
    }

    all(path: string): SolicitudesRestangularService {
        const restangular = this.clone();
    ...
    clone(): SolicitudesRestangularService {
        return new SolicitudesRestangularService(this._http, this.router, {
            solicitudesApi: this.baseUrl,
