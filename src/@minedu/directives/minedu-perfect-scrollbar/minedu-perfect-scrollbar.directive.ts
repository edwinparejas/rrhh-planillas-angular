...
import { MineduPerfectScrollbarGeometry, MineduPerfectScrollbarPosition } from '@minedu/directives/minedu-perfect-scrollbar/minedu-perfect-scrollbar.interfaces';
import { MineduConfigService } from '@minedu/services/config.service';

@Directive({
    selector: '[mineduPerfectScrollbar]'
})
export class MineduPerfectScrollbarDirective implements OnInit, AfterViewInit, OnDestroy
{
    ...
    @Input()
    set mineduPerfectScrollbarOptions(value)
    {
    ...
    get mineduPerfectScrollbarOptions(): any
    {
        return this._options;
    }
   
    @Input('mineduPerfectScrollbar')
    ...
    ngAfterViewInit(): void
    {
        ...
        if ( this.mineduPerfectScrollbarOptions.updateOnRouteChange )
        {
            this._router.events
                .pipe(
                    takeUntil(this._unsubscribeAll),
    ...
    _init(): void
    {
        ...
        this.ps = new PerfectScrollbar(this.elementRef.nativeElement, {
            ...this.mineduPerfectScrollbarOptions
        });
    ...
    geometry(prefix: string = 'scroll'): MineduPerfectScrollbarGeometry
    {
        return new MineduPerfectScrollbarGeometry(
    ...
    position(absolute: boolean = false): MineduPerfectScrollbarPosition
    {
        if ( !absolute && this.ps )
        {
            return new MineduPerfectScrollbarPosition(
                this.ps.reach.x || 0,
                this.ps.reach.y || 0
            );
        }
