...
import { MineduSidebarService } from './sidebar.service';
...
@Component({
    selector     : 'minedu-sidebar',
    templateUrl  : './sidebar.component.html',
    styleUrls    : ['./sidebar.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class MineduSidebarComponent implements OnInit, OnDestroy
{
    @Input()
    name: string;
    ...
    ngOnInit(): void
    {
        this._mineduConfigService.config
            ...
            .subscribe((config) => {
                this._mineduConfig = config;
            });

        this._mineduSidebarService.register(this.name, this);
    ...
    ngOnDestroy(): void
    {
        ...
        this._mineduSidebarService.unregister(this.name);
    ...
    private _showBackdrop(): void
    {
        ...
        this._backdrop.classList.add('minedu-sidebar-overlay');
        if ( this.invisibleOverlay )
        {
            this._backdrop.classList.add('minedu-sidebar-overlay-invisible');
        }
